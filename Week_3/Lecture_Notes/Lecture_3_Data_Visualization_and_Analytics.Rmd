...
ggplot(data_df_sub, aes(x = RIDAGEYR, y = BPXOSY1)) +
  ...
  theme_minimal()
```
The plot we created above indicates that for every year of increase in age, systolic blood pressure increases by 0.4 units. The positive relationship is highlighted by the slight up slope of the regression line. 
