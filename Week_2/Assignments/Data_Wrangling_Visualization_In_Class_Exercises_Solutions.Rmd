...
dat <- read.csv("/Users/f002yt8/Documents/GitHub/HDS-Foundations_of_Data_Science/Week_2/Data/In_Class_Exercises_Arsenic.csv")
...
2) Using `ggplot2()`, generate another box plot using the data frame of NHANES data from the previous question, but this time make it a box plot grouped by gender on the x-axis. Break up each of the groups by marital status. Add a jitter to each of the box plots. 
